...
public class Test {
    public static void main(String[] args) {
        ...
        Premiu oscar2018= new Premiu("osca", 2018);
        ...
        Film film2 = new Film(2010, "film cu actori fara premii", new Actor[]{actorFaraPremii01,actorFaraPremii02,actorFaraPremii03});
        Film film4 = new Film(2018,"film cu actori de oscari", new Actor[]{actorOscar2010,actorOscar2018,actorFaraPremii02});
        Film film3 = new Film(2010, "film cu actori fara oscar", new Actor[]{actorFaraPremii01,actorFaraPremii02,actorFaraPremii03});
